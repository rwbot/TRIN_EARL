...
if("FALSE" STREQUAL "TRUE")
  set(libfovis_SOURCE_PREFIX /home/trin_igvc/libfovis)
  set(libfovis_DEVEL_PREFIX /home/trin_igvc/libfovis/build/devel)
  set(libfovis_INSTALL_PREFIX "")
  set(libfovis_PREFIX ${libfovis_DEVEL_PREFIX})
else()
  set(libfovis_SOURCE_PREFIX "")
  set(libfovis_DEVEL_PREFIX "")
  set(libfovis_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libfovis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Pep Lluis Negre <pl.negre@uib.cat>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/trin_igvc/catkin_ws/devel/lib;/opt/ros/jade/lib)
